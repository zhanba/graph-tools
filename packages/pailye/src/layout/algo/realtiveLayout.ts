...
class RealtiveLayoutDefinition extends AbstractLayoutDefinition {
  intrinsicSizes(
...
export class RelativeLayout implements LayoutContribution {
  registerLayout(layoutRegistry: LayoutRegistry) {
    layoutRegistry.registerLayout('relative', RealtiveLayoutDefinition);
  }
}
